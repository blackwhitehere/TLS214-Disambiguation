...
--tentative easy_year
select *, dbo.IsMatchValue(npl_biblio, '(18[5-9][0-9])|(19[0-9][0-9])|(20(0|1)[1-5])') as easy_year
into #tmp1
from sample_unique
go
...
--easy type
select *, dbo.IsMatchValue(npl_biblio, 'Journal|Magazine|Abstract|Article') as easy_type
into #tmp1
from sample_unique
go
...
from sample_unique as su join #month_date as a on su.npl_publn_id=a.npl_publn_id
...
/*select su.npl_publn_id, a.month_date, b.easy_year
